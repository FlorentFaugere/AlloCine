 ...
 */
final class Version20221229120222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, composers_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, release_date DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', synopsis LONGTEXT DEFAULT NULL, INDEX IDX_1D5EF26FDC6510CB (composers_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
